...
import { ArrowRight, Calendar, Heart, Users, Sparkles } from "lucide-react";
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="relative animate-fade-up stagger-2">
            <div className="relative z-10">
              <PlaceholderImage 
                aspectRatio="square" 
                label="Hero image - Cultural event photography"
      ...
      <div className="container-wide">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <div className="order-2 lg:order-1">
            <PlaceholderImage 
              aspectRatio="video" 
              label="Community gathering photo"
      ...
      <div className="container-wide">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
          <SectionHeading 
            ...
            subtitle="Stories and news from our community"
            className="mb-0"
          />
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {posts.map((post, index) => (
            <article 
              key={index}
              className="group bg-card rounded-2xl overflow-hidden border border-border/50 shadow-soft hover:shadow-elevated transition-all duration-300"
            >
              <PlaceholderImage 
                aspectRatio="video" 
          ...
          <div>
            ...
            <div className="space-y-6">
              {events.map((event, index) => (
                <div 
                  key={index}
                  className="p-6 rounded-xl bg-card border border-border/50 shadow-soft hover:shadow-elevated transition-all duration-300"
                >
